import 'package:pulse_chat/features/search/presentation/search_page/search_page.dart';
import 'package:pulse_chat/features/group/presentation/group_pages/view/group_create_screen.dart';
...
class SearchAppBar extends StatelessWidget {
  ...
  void _navigateToSearchView(BuildContext context) {
    ...
    Navigator.of(context, rootNavigator: true).push(
      PageRouteBuilder(
        pageBuilder:
            (context, animation, secondaryAnimation) => const SearchPage(),

...
class GroupCreateDialogState extends State<GroupCreateScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final contactNotifier = Provider.of<ContactsNotifier>(
        context,
        listen: false,
      );
      contactNotifier.getFriendList();
    });
  }

  @override
  Widget build(BuildContext context) {
    return Consumer3<ContactsNotifier, GroupCreateNotifier, SearchNotifier>(
      builder:
  ...
  Widget buildBody(
    ...
    ContactsNotifier contactVM,
    GroupCreateNotifier groupVM,
  ...
  Widget _groupNameTextField(GroupCreateNotifier groupViewModel) {
    return Row(
  ...
  Widget _searchUsertextField(SearchNotifier searchVM) {
    return TextField(
  ...
  void chooseImage(GroupCreateNotifier groupVM) async {
  ...
  Widget _chooseImageWidget(GroupCreateNotifier groupVM) {
  ...
  Widget _seletedGroupMembers(GroupCreateNotifier groupVM) {
    return Column(
  ...
  String? validateGroupDetail(GroupCreateNotifier groupVM) {
  ...
  void createGroup(GroupCreateNotifier groupVM) async {

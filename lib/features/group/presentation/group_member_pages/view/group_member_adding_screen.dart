...
class GroupMemberAddingScreenState extends State<GroupMemberAddingScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      groupMemberVM.checkPreSendRequest(groupId);
    });
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<GroupInvitingUsersNotifier>(
      builder:
  ...
  Widget _groupMemberSelections(GroupInvitingUsersNotifier groupMemberVM) {
    return _contactSelections(groupMemberVM);
  }

  Widget _contactSelections(GroupInvitingUsersNotifier groupMemberVM) {
  ...
  Widget _seletedGroupMembers(GroupInvitingUsersNotifier groupMemberVM) {
    return Column(
  ...
  void confirmAdding(GroupInvitingUsersNotifier groupMemberVM) {
